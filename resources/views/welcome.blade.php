                                                        ...
                                                        <form action="{{ route('update.product') }}" method="post"
                                                            ...
                                                            <div class="mb-3">
                                                                <input type="text" name="product_name"
                                                                    ...
                                                                    placeholder="Product Name" value="{{$item->product_name}}">
                                                            </div>
                                                            <div class="mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                <input type="text" name="price" id=""
                                                                    class="form-control" placeholder="Price" value="{{$item->price}}">
                                                            </div>
                                                            <div class="mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                <img src="{{asset($item->product_image)}}" alt="" id="showImage" width="70px" height="70px">
                                                            </div>
                                                            <div class="mb-3">
